...
<script>
	...
	<div class="cf">
		<div class="fl">
			...
			<button class="btn ajax-post" target-form="ids" url="<?php echo U("Article/setStatus",array("status"=>-1));?>">删 除</button>
		...
		<table>
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <?php
 switch($data['position']) { case 0: $str="无"; break; case 1: $str="列表推荐"; break; case 2: $str="频道页推荐"; break; case 4: $str="首页推荐"; break; case 8: $str="首页特惠产品"; break; case 16: $str="首页云产品"; break; case 24: $str="首页云产品,首页特惠产品"; break; default: $str="无"; } ?>
                        <td ><?php echo ($str); ?></td>
