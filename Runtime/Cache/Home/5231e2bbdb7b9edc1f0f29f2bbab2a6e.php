...
<div class="news-main">
    <div class="inner">
        <div class="base-line clearBoth">
            ...
            <!-- <p class="fl"><?php echo ($category["title"]); ?></p> -->


        </div>
        <!-- <div class="news-content">
            <div class="title"><?php echo ($info["title"]); ?></div>
            <p>发布时间：<?php echo (date('Y-m-d',$info["create_time"])); ?><span>来源：数梦工场</span>浏览：<?php echo ($info["view"]); ?></p>
        </div> -->
        <div class="news-con">
        <?php echo get_category($_GET['catid'],'content');?>
        </div>
        <!-- <div class="pre clearBoth">
          <?php $prev = D('Document')->prev($info); if(!empty($prev)): ?><p class="fl">上一篇：<a href="<?php echo U('?id='.$prev['id']);?>"><?php echo ($prev['title']); ?></a></p><?php endif; ?>
              <?php $next = D('Document')->next($info); if(!empty($next)): ?><p class="fr">下一篇：<a href="<?php echo U('?id='.$next['id']);?>"><?php echo ($next['title']); ?></a></p><?php endif; ?>
        </div> -->
    </div>
</div>
<div class="footer">
