...
<div class="news-main">
    <div class="inner">
        ...
        <div class="product-center clearBoth">
            <a  class="left fl"><img src="<?php echo get_cover($info['product'],'path');?>"></a>
            <div class="right fl">
                <a href="" class="title"><?php echo ($info['title']); ?></a>
                <div class="text">
                  <?php echo ($info['description']); ?>
                </div>
                <div class="bot clearBoth">
                    <a href="<?php echo ($info['ljxg']); ?>" class="a1 fl">立即购买</a>
                    <!-- <a href="<?php echo ($info['xptj']); ?>" class="a2 fl">选配推荐</a> -->
                    <div class="a2 fl" style="padding-left:20px !important;padding-top:5px !important;"><?php echo ($info['price']); ?>元起</div>
                </div>
            </div>
        </div>
        <div class="ke-content product-con">
