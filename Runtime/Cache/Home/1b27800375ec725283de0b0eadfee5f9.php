...
<div class="news-main">
    <div class="inner">
        ...
        <div class="ke-shop clearBoth">
            <a  class="left fl"><img src="<?php echo get_cover($info['pimage'],$field = path);?>"></a>
            <div class="right fl">
                <a  class="title"><?php echo ($info['title']); ?></a>
                <p><span>价格：</span><span>¥</span><?php echo ($info['price']); ?><span>元</span></p>
               ...
               <a href="javascript:;" class="gou" onclick="addcar()">立即购买</a>
                <!-- <a href="<?php echo ($info['ljxg']); ?>" class="gou" target="_blank">立即购买</a> -->
            </div>
        </div>
...
<script type="text/javascript">
         function addcar()
         {
           var productid="<?php echo ($info['id']); ?>";//id
           var image="<?php echo ($info['pimage']); ?>";//图片
           var name="<?php echo ($info['title']); ?>";//名称
           var num=$('.baseInput').val();//数量
           var price="<?php echo ($info['price']); ?>";//单价
           $.ajax({
             url:"<?php echo U('User/car','',false);?>",
             type:"GET",
