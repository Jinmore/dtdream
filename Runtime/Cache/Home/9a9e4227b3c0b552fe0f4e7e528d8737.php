...
<div class="news-main">
    <div class="inner">
        ...
        <ul class="newsUl">
          <?php $category=D('Category')->getChildrenId($_GET['catid']);$__LIST__ = D('Document')->page(1,10)->lists($category, '`level` DESC,`id` DESC', 1,true); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li class="clearBoth">
        ...
        <div class="page">
    			<?php $__CATE__ = D('Category')->getChildrenId($_GET['catid']);$__PAGE__ = new \Think\Page(get_list_count($__CATE__), 10);echo $__PAGE__->show(); ?>
    		</div>
    </div>
</div>
<div class="footer">
