...
<div class="news-main">
    <div class="inner">
        <div class="base-line clearBoth">
            ...
            <p class="fl">开发者课堂</p>
            <!-- <ul class="fr clearBoth">
                <li class="bg"><a href="">云计算课程</a></li>
                <li><a href="">大数据课程</a></li>
            </ul> -->
        </div>
        <ul class="yun ke clearBoth">
           <?php $category=D('Category')->getChildrenId(75);$__LIST__ = D('Document')->page(1,12)->lists($category, '`level` DESC,`id` DESC', 1,true); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ketang): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo U('Article/detail?id='.$ketang['id'].'&catid=75');?>"><img src="<?php echo get_cover($ketang['cover_id'],$field = path);?>"></a>
                <div class="text">
                    <a href="<?php echo U('Article/detail?id='.$ketang['id'].'&catid=75');?>"><?php echo ($ketang['title']); ?></a>
                    <?php echo (msubstr($ketang[description],0,45)); ?>
                </div>
                <div class="bot clearBoth">
                    <div class="a2 fl"><?php echo ($ketang['price']); ?>元起</div>
                    <a href="<?php echo U('Article/detail?id='.$ketang['id'].'&catid=75');?>" class="a1 fr">立即选购</a>
                </div>
